    ...
    return (
        ...
        >
            ...
            <Tooltip title="Filter list">
                <IconButton sx={{ fontSize: "20px", marginRight: "20px", color: "#0076DF" }}>
        ...
        <div className="products">
            <div className="product-top">
                <div className='product-top-child'>
                    <div >
                        <h2>Products</h2>
                        <p>Manage and create products, kits, and parent products to easily view/set inventory levels, keep track of important product information, and manage listings.</p>
                    </div>
                    <div className="pro-btns">
                        <button className='upload-btn'>Upload Inventory</button>
                        <button id='create-btn'>Create Product <div><RiArrowDropDownLine id='dropdown' /></div></button>
                        <button style={{ width: "120px" }} id='create-btn'>Actions <div><RiArrowDropDownLine id='dropdown' /></div></button>
                    </div>
                </div>
